...
public class aniLearn : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (var i = 0; i < Items.Length; i++)
        {
            ...
            clip.SetCurve(relativePath, typeof(Transform), "localScale.x", curve);
            clip.SetCurve(relativePath, typeof(Transform), "localScale.y", curve);
